                ...
                {!masterPromptPackage && !isGeneratingMasterPrompt ? (
                  <div className="mx-auto flex max-w-3xl flex-col gap-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50/70 p-8">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <p className="max-w-2xl text-sm leading-6 text-slate-600">One-time generation per project. ADES uses your saved board, evals, safeguards, and assumptions.{isAdminBypass ? " Admins can force regenerate." : ""}</p>
                    </div>
                  </div>
                ) : null}
