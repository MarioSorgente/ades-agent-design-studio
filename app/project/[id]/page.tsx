...
export default function ProjectPage() {
  ...
  async function handleGenerateMasterPromptPackage(forceRegenerate = false) {
    ...
    try {
      ...
      if (payload.usedFallbackGraders) setMasterPromptError("The master prompt was saved with local fallback graders because AI grader generation hit temporary traffic. Review the fallback grader details before production use.");
