...
const floatingSignals = [
  ...
  { label: "Business metric", className: "left-[14%] bottom-[30%] lg:bottom-[24%] animate-float-delayed" },
  { label: "Human handoff", className: "right-[14%] bottom-[32%] lg:bottom-[25%] animate-float-slow" }
];
